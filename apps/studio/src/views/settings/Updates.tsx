...
/**
 * How this copy of Scenri stays current: the Updates row, what changed, and
 * the switch that decides whether Scenri ever checks by itself. The switch
 * sits under the row it governs.
 */
