/**
 * The tour's hold on the page: everything but the card and the stop's own
 ...
 * the page the same way whenever a dialog opens; a tour paused under a dialog
 ...
 */
export const LOCK_MARK = 'data-sc-tour-inert';

const NEVER = new Set(['SCRIPT', 'STYLE', 'LINK', 'META', 'TEMPLATE', 'NOSCRIPT']);

export interface TourLock {
...
export function createLock(root: Element = document.body): TourLock {
