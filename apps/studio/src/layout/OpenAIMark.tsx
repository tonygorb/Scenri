 ...
 * unmodified so the mark is never redrawn or distorted. "OpenAI" and "ChatGPT"
 * are trademarks of OpenAI; the CC0 licence covers the artwork file, never the
 * trademark. See NOTICE.
 */
