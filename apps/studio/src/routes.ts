...
export const sceneStudioPath = (b: BrandLike): string => generatePath(P.sceneStudio, { brandSlug: b.slug });
export const sceneEditPath = (b: BrandLike, sceneId: string): string =>
  generatePath(P.sceneEdit, { brandSlug: b.slug, sceneId });
