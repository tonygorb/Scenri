# Contributor License Agreement (Individual, v1 draft)
...
5. **Representations.** The Contribution is Your original creation, You are legally entitled to grant these licenses, and if Your employer has rights in Your work You have permission or the employer has waived such rights.
6. **No warranty.** Contributions are provided "AS IS" without warranties of any kind.

*Note: this draft will be finalized (and possibly assigned to a legal entity) before the first external contribution is merged. Signature is collected via CLA-assistant on pull requests.*
