...
* **cli:** a reference or mark that found no seat is carried in words ([5a85996](https://github.com/tonygorb/Scenri/commit/5a859969b0ad922a8fc1fea062d58f39aa477776))
* **cli:** photo seats go out in the brief's order, marks and references first ([f4b342e](https://github.com/tonygorb/Scenri/commit/f4b342e030cca84e7cc275fba8f13eaee4457fe5))
* **cli:** photo seats go out in the brief's own order, whatever the kind ([989d26f](https://github.com/tonygorb/Scenri/commit/989d26f7892da72081341bbde7e00e72a6b765bf))
* **studio:** 26px pill chips with 18px thumbs on the token ladder ([fa8cdc0](https://github.com/tonygorb/Scenri/commit/fa8cdc083fa6fde3bfc4c664c9bc1916b59f36e3))
* **studio:** a hard photo cap at every door, the reason on every chip ([f0b7fd0](https://github.com/tonygorb/Scenri/commit/f0b7fd01ec5a7835725534202b804bc8a416dc96))
* **studio:** a reference chip says what it is ([05a1177](https://github.com/tonygorb/Scenri/commit/05a11777d6addcbbba6f2cbe80760984483f4bd4))
* **studio:** add composer chip, refine, and send tokens ([0fc8d88](https://github.com/tonygorb/Scenri/commit/0fc8d8815bc79afe545c3c4dee295c371bd201b1))
* **studio:** brand mark thumb keeps the circle, contained on white ([b9cede9](https://github.com/tonygorb/Scenri/commit/b9cede910103ca4bf36da438aa5980e11254f903))
* **studio:** compact 24px chips and the inverse Refining card ([a7a81ff](https://github.com/tonygorb/Scenri/commit/a7a81ff8ec5defb8324ea8bd728a9c9ca26d9de3))
* **studio:** composer shell rest shadow and editing border from Figma pass ([7485bac](https://github.com/tonygorb/Scenri/commit/7485bacb9ba2befe33522601976b8f7aa39e12b9))
* **studio:** custom scenes tint from their preview, chips peek on hover ([9033b46](https://github.com/tonygorb/Scenri/commit/9033b46d000ac87bb66b813faf72f8bef8025346))
* **studio:** iris treatment for brand-owned custom scene chips ([d6e09e9](https://github.com/tonygorb/Scenri/commit/d6e09e958102d4ae42db49d10bacfefc92219caf))
* **studio:** refine-blue Refining chip in every refine composer ([386992c](https://github.com/tonygorb/Scenri/commit/386992c792edea044b7a8cb4610d230d8bc8f800))
* **studio:** refuse a photo chip the engine cannot carry ([5b5f550](https://github.com/tonygorb/Scenri/commit/5b5f5509e059e0abfe381ed6b36b0e3e4d77d2d3))
* **studio:** the band keeps its world, folds the rest into a stack of faces ([0d6dc36](https://github.com/tonygorb/Scenri/commit/0d6dc36ce0976effea7055261dad20997c0ef74d))
* **studio:** the band shows what fits and counts the rest ([b8e0d56](https://github.com/tonygorb/Scenri/commit/b8e0d56596184e7aaf3368268911a34da5572eed))
* **studio:** the band's +N opens its rest in a popover, and handled keys stay handled ([9462c9e](https://github.com/tonygorb/Scenri/commit/9462c9e251961352efbf1901824a94aa960b3e12))
* **studio:** the brief fades where more of it waits below the fold ([5e2b477](https://github.com/tonygorb/Scenri/commit/5e2b47749f3fcdddfca7f687632c3f81241a858f))
* **studio:** the Create rail is the composer's mirror ([172489b](https://github.com/tonygorb/Scenri/commit/172489be5f5804052a5a4a9ad786c54e70863850))
* **studio:** the overlay composer wears the picture's contents in its band ([36a0e8f](https://github.com/tonygorb/Scenri/commit/36a0e8f0f2252681ade35de4c5fca720ea3800d5))
* **studio:** the refine sidebar redesigned to its Figma frames, with a draggable seam ([e0daf6a](https://github.com/tonygorb/Scenri/commit/e0daf6aab9a880f40e81350f6a2701f426ec59f4))
* **studio:** the source cards ride one sideways strip, however many ([321317a](https://github.com/tonygorb/Scenri/commit/321317a3646537d0841f1c8f5d53b1c1971a9358))
* **studio:** toolbar rhythm, quiet aspect trigger, dark send pill ([dc62bd2](https://github.com/tonygorb/Scenri/commit/dc62bd239e953ff27f4b27c3bdbbf22e18b52951))
* **studio:** twelve identities per shot, the pictured ones lit, the rest dimmed ([6b54966](https://github.com/tonygorb/Scenri/commit/6b5496611592c7caf55c53b309326e7556fad2eb))
* **studio:** words carry look, pixels carry likeness ([c380b1e](https://github.com/tonygorb/Scenri/commit/c380b1e068a49cad9a96c6ce04d8eb3d65e1787f))
* the composer, the Create rail and the shot feed to their Figma frames ([dc2338d](https://github.com/tonygorb/Scenri/commit/dc2338d40a79ee7d1986f9c2d3dd2719724b4414))


### Bug Fixes

* **cli:** a budget loss on an engine that reads images generates ([e28987f](https://github.com/tonygorb/Scenri/commit/e28987f7f877f262a4be72aa5ca9ef335a852fee))
* **cli:** a colour chip is a parenthetical, and the names line leads the directives ([e94b196](https://github.com/tonygorb/Scenri/commit/e94b196c1f21941c222065b11fabebd203ca34db))
* **cli:** a finished shot settles the moment it lands, not when its siblings do ([ea3fc02](https://github.com/tonygorb/Scenri/commit/ea3fc023a1ad0e21a3c9bc8bc0b466b74e6cf66a))
* **cli:** a name in the brief is a thing to show, never a word to write ([118f86e](https://github.com/tonygorb/Scenri/commit/118f86ee59a993aa06f26028b1d48d20920e589b))
* **cli:** a refinement seats its own chips in the brief's order too ([130425d](https://github.com/tonygorb/Scenri/commit/130425d3225ffc96628df39ed4ed0a0ca14090da))
* **cli:** two presenters share a scene's figure, a seatless photo is not called lost, a same-size step-down is no step ([bcd4ef9](https://github.com/tonygorb/Scenri/commit/bcd4ef9fb1d16b4353aaaac410c2ee2d57cb1a3e))
* **studio:** a batch sent from a set files every shot, and a late answer stays with its brand ([5f55d84](https://github.com/tonygorb/Scenri/commit/5f55d84b006941261744028d2baf47e2719f71bb))
* **studio:** a caret on the line beside a chip is drawn, and a press at a line edge takes nothing ([c98449b](https://github.com/tonygorb/Scenri/commit/c98449b788c180db47edd85d4f4db1b74a6c8c43))
* **studio:** a chip and the space after it are one thing to the keyboard ([9c3f64d](https://github.com/tonygorb/Scenri/commit/9c3f64da7349e630f8a0ef140dc7988c89656a5b))
* **studio:** a chip centres its label and never flips for a right-to-left name ([0bbad13](https://github.com/tonygorb/Scenri/commit/0bbad13adf62ac6a0974d14cfbed4b36b64c30cf))
* **studio:** a chip's mark costs no layout and does not blink ([5af13f2](https://github.com/tonygorb/Scenri/commit/5af13f2b5f6fc5b068cef4235baa1c6a7213ef8d))
* **studio:** a drag closes the peek and shows one drop target ([4c7eb53](https://github.com/tonygorb/Scenri/commit/4c7eb531b73c678f58216843b2726c864a0c7f94))
* **studio:** a drop after a row's last chip lands after it, and a row-start slot draws on its row ([2d42e18](https://github.com/tonygorb/Scenri/commit/2d42e189a628efeb0fbd954319b8ebccb5f9af36))
* **studio:** a landed shot changes one tile, and the bell reads the whole batch ([8c77615](https://github.com/tonygorb/Scenri/commit/8c77615ab2d8e1d99114ee8c3a022e7a259cddb2))
* **studio:** a seatless reference or mark dims and explains itself, no dot ([90c5014](https://github.com/tonygorb/Scenri/commit/90c501414cdbaaf84ff999f19b4f59ceb39795e6))
* **studio:** a space typed at a chip's edge never doubles the one the chip owns ([916bff7](https://github.com/tonygorb/Scenri/commit/916bff7c6e6a24f164e593281389ece4d6feb005))
* **studio:** an unknown cap says nothing about why a photo stayed home ([3894965](https://github.com/tonygorb/Scenri/commit/38949657da2ac431760d0de902b9708dd5af4bf0))
* **studio:** band-owned composer paddings survive the editor's scroll ([ece0de2](https://github.com/tonygorb/Scenri/commit/ece0de2611a80b172ec7c796c9153648e5d9fe2f))
* **studio:** brand rules are the compiler's context, not a row in the composer ([a6c8f5a](https://github.com/tonygorb/Scenri/commit/a6c8f5a129843bc239f58e3606511e9b8951ff0a))
* **studio:** chip rows keep their 4px gap, and the rail dims at the ceiling too ([013e727](https://github.com/tonygorb/Scenri/commit/013e727fb7679c1136db78d6aac506e1f48c13b0))
* **studio:** light editing border meets the 3:1 register its dark twin holds ([781b07c](https://github.com/tonygorb/Scenri/commit/781b07c6c254c1f0484677f03212a733a369b78c))
* **studio:** one chip per thing, whichever door asked ([6ce90e8](https://github.com/tonygorb/Scenri/commit/6ce90e8153d42b2de3dd60efb6900d5bd7df2a43))
* **studio:** one drop caret per gap, centred in it, and the dashed slot is back ([060aa15](https://github.com/tonygorb/Scenri/commit/060aa151d5c6a91068a23f60b310329422bf5528))
* **studio:** one sentence for every chip whose photo found no seat ([3d25870](https://github.com/tonygorb/Scenri/commit/3d258708de83fb8e5c1598e9b7ab03ddbf7b442e))
* **studio:** sturdier chips, warn as a warm wash, Refining back to the hub alone ([95b554b](https://github.com/tonygorb/Scenri/commit/95b554bb85ed34c45a50318252949df568636ae7))
* **studio:** the band carries the source, never the shot's own ask ([de59e54](https://github.com/tonygorb/Scenri/commit/de59e54a5c7db5c78b469d803818368ee9b465e9))
* **studio:** the card's line keeps the stronger hook where it is true ([3e6c3b8](https://github.com/tonygorb/Scenri/commit/3e6c3b8a0a93060f493f8a037fd45e5a1c353773))
* **studio:** the caret between two chips sits in the middle of the gap, and a tap in prose keeps the platform's caret ([248f4da](https://github.com/tonygorb/Scenri/commit/248f4da838505bc380bb80e9bf279b7301aa9995))
* **studio:** the caret lives in text again, and a keystroke never shapes the prose ([61dd6a8](https://github.com/tonygorb/Scenri/commit/61dd6a8978cbc3aa504a5208dca1eccd740babc0))
* **studio:** the ceiling explains itself on hover, and nothing moves ([943b400](https://github.com/tonygorb/Scenri/commit/943b40021738debaf88417fc5249c429e3d6aa0c))
* **studio:** the ceiling tooltip wears the app's own surface, in one short line ([41909f8](https://github.com/tonygorb/Scenri/commit/41909f8caa3e1d7f826a7256b144a27a9c1eaacd))
* **studio:** the chip's X fade takes its direction as an angle ([d70c5e6](https://github.com/tonygorb/Scenri/commit/d70c5e64d70a359681d3779b4821e6f41663f50f))
* **studio:** the Create row and its asset rail take the Figma's numbers ([195518e](https://github.com/tonygorb/Scenri/commit/195518e14bb6a66aa636420fbb4124462854cbc5))
* **studio:** the dragged chip leaves the line, so there is one place to drop ([3bed9ef](https://github.com/tonygorb/Scenri/commit/3bed9ef01fa4756c5c1b029985ba78316b8c99a3))
* **studio:** the peek card always opens the lightbox, and dies when a picker opens ([9254e67](https://github.com/tonygorb/Scenri/commit/9254e67dcfd7a42ccb7fe5a386cbcc93bbaec18d))
* **studio:** the peek card names the thing, and a right-to-left chip keeps its X gutter ([40b8605](https://github.com/tonygorb/Scenri/commit/40b860574396bae581944059e7dfdc0dda60262b))
* **studio:** the phone panel's dividers run full width too ([abb8ec6](https://github.com/tonygorb/Scenri/commit/abb8ec6b55b7d4e0defba1b0927fb865b41a61c0))
* **studio:** the quiet toolbar controls wear the row's full-round shape ([f4ae578](https://github.com/tonygorb/Scenri/commit/f4ae578cfad607a6a35473fdf5230b1acccc9a65))
* **studio:** the rail opens on one clock, and the row's left group speaks one size ([d82d032](https://github.com/tonygorb/Scenri/commit/d82d032ba54898adfc2aa0ffe58d87cd07e2e773))
* **studio:** the running clock reads minutes and seconds ([f3122e1](https://github.com/tonygorb/Scenri/commit/f3122e1f52c4cbc48511f3385a407d4c1db4fd7e))
* **studio:** the scene card's reason for sitting out can be read ([e1790ed](https://github.com/tonygorb/Scenri/commit/e1790edd388fe2cf24b43b4ff463a70b4eb19ae6))
* **studio:** the source cards read the whole lineage, the record says nothing twice ([909730e](https://github.com/tonygorb/Scenri/commit/909730eed2bdce3fb079104f411449e202d0a74f))
* **studio:** true 4px chip gaps, a warn dot instead of colour, full-width dividers ([b8c7e40](https://github.com/tonygorb/Scenri/commit/b8c7e400a4fee673189e9312417f2f1914c1966a))
* **studio:** two chips keep the one space between them, however the one before them left ([29f3b9d](https://github.com/tonygorb/Scenri/commit/29f3b9dbbe2eb60aefb582f0bb317adbc8f9cda0))
* **studio:** warn ring fits the pill, and only a settled preview may flag ([d89ac37](https://github.com/tonygorb/Scenri/commit/d89ac37e4b99137764a7da1195ff82d299cd651a))
...
* add avatarUrl to Presenter interface and update related components ([13ad22d](https://github.com/tonygorb/scenri/commit/13ad22df87d2025e0f75573b31b15a5176a13951))
* add cancellation functionality and enhance task management ([ca480e8](https://github.com/tonygorb/scenri/commit/ca480e8d23f405c91c697ec89901fca0f4e55f99))
* add Looks loading signal and dangling-look cleanup ([a2dafd1](https://github.com/tonygorb/scenri/commit/a2dafd178a19e8194530a098b8c53f5ed8dbe194))
* add react-colorful dependency and implement brand kit features ([b787258](https://github.com/tonygorb/scenri/commit/b787258859632839464911bd6872974ee9cbf4a0))
* add scrollbar-gutter property for stable layout during content height changes ([045aa97](https://github.com/tonygorb/scenri/commit/045aa975e5ff10d238e1504da909b0e1109fc47c))
* **api:** enhance product management and library functionality ([d9237bc](https://github.com/tonygorb/scenri/commit/d9237bc201551a77cdced6c141967d93c99a5439))
* **biome:** add VCS configuration and accessibility rule updates ([26f3309](https://github.com/tonygorb/scenri/commit/26f33099007f53c50a65232a177d4cd1463a91f2))
* browser titles that name the surface, and credit in About ([f0ff02a](https://github.com/tonygorb/scenri/commit/f0ff02a2aa5cc4993ed359ec4ec1a35fec1c99f0))
* **cli:** supervising launcher, staged installs, scenri update ([a412245](https://github.com/tonygorb/scenri/commit/a4122457c446816f3dd0d3084bb5959e2d08ece4))
* **cli:** version identity, graceful shutdown, DB schema gate ([3a15cb6](https://github.com/tonygorb/scenri/commit/3a15cb69ee6065103a23469d0690c2e602459d2e))
* **composer:** enhance color handling and insert menu functionality ([ef051ec](https://github.com/tonygorb/scenri/commit/ef051ecd144f06fe3ee26e9e3a8de132ad9abbac))
* **composer:** implement insert menu for product, presenter, and scene selection ([26aa552](https://github.com/tonygorb/scenri/commit/26aa552a04cc60ad54be1954a3d492a3ddb53a73))
* **context:** add context bundle generation and mockup capture scripts ([7c14d74](https://github.com/tonygorb/scenri/commit/7c14d740a10e19e62051a0a3432ff7d1a1f39d19))
* **dialogs:** implement sheet drag functionality and enhance asset creation forms ([e1c8bc9](https://github.com/tonygorb/scenri/commit/e1c8bc90110e4a79d5c104a42f1e68cf6943412e))
* enhance branding and error handling in the application ([4386bc9](https://github.com/tonygorb/scenri/commit/4386bc90c81f49fed37a6fde93c9ce92ef1a9d9f))
* enhance demo product handling and upload functionality ([7658c44](https://github.com/tonygorb/scenri/commit/7658c44f248f39dcac361fcf79c94e6d8daf788b))
* enhance demo product integration and UI presentation ([504051f](https://github.com/tonygorb/scenri/commit/504051f26f5547fa84ecb232791f6d2887637223))
* enhance DensityControl and ShowcaseCard components for improved layout and density management ([5fa9565](https://github.com/tonygorb/scenri/commit/5fa9565ec79609cf0d673a669aff309cbb555d63))
* enhance design documentation and improve CatalogCard functionality ([c025b35](https://github.com/tonygorb/scenri/commit/c025b35a9d94489e853947102f762b0368a252a1))
* enhance development environment and UI components ([3c4640d](https://github.com/tonygorb/scenri/commit/3c4640dc09308c3332f8d4dd38910f7037623934))
* enhance focus management and ingredient handling in composer ([851d552](https://github.com/tonygorb/scenri/commit/851d5522330f6875dc00e7d9f89281f6c0e3700b))
* enhance product management and UI interactions ([0bdbaec](https://github.com/tonygorb/scenri/commit/0bdbaec3d43b4a23dae153bff0feaf268ab0b724))
* enhance product upload handling and improve component interactions ([ee140a5](https://github.com/tonygorb/scenri/commit/ee140a5abff055c3537b495d934f5499030d0fee))
* enhance README and design system for improved clarity and usability ([5c90405](https://github.com/tonygorb/scenri/commit/5c90405ed6ceb1c6604824b7eaa9b0002f67582f))
* enhance routing and UI for sets and shots ([c06b096](https://github.com/tonygorb/scenri/commit/c06b096902b0b42fc326737cd7ec7430badcf026))
* enhance Scene and DemoProduct interfaces with new properties for improved searchability ([daa0aa3](https://github.com/tonygorb/scenri/commit/daa0aa35e02f60c466b05380758830fd5dd14d07))
* expand API with asset build functionalities and enhance asset management ([ff92f21](https://github.com/tonygorb/scenri/commit/ff92f21cbcd0580c72c8076423595c0c75d01ef9))
* expand creative system with new presenters and look templates for enhanced product diversity ([1b38b95](https://github.com/tonygorb/scenri/commit/1b38b957973e7d41179656fca814fc7e396e5195))
* implement archiving and deletion functionality for nodes ([37449dc](https://github.com/tonygorb/scenri/commit/37449dc72bb30aa51caa71b35f72758b4ba89fdb))
* implement ingredient picker and enhance chip interaction in composer ([1fd9c79](https://github.com/tonygorb/scenri/commit/1fd9c79d030e38e2fc9b581c90261996df4281e9))
* improve AssetsPanel transition effects and content display logic ([f5cb1f8](https://github.com/tonygorb/scenri/commit/f5cb1f88e3d1b4235b3e85afad0cb3f7c7abdf42))
* integrate @radix-ui/react-focus-scope and enhance Canvas component ([69bc4de](https://github.com/tonygorb/scenri/commit/69bc4de67c3bbd539f620b6152bed59097ab2a88))
* integrate react-router and add react-router dependency ([ad2f415](https://github.com/tonygorb/scenri/commit/ad2f415fcf48272d4edd0b8087dfc5409f417d6e))
* integrate ScrollPane component for improved layout consistency across views ([97a743e](https://github.com/tonygorb/scenri/commit/97a743e377b96cfbf29daafb7e11f10710919489))
* introduce creative system skills and references for enhanced content generation ([a621afb](https://github.com/tonygorb/scenri/commit/a621afb4c66504e266c28d5023614faaaf233ae1))
* introduce demo products and showcase features with API integration ([593f09d](https://github.com/tonygorb/scenri/commit/593f09d16ea254ab532c4abef6bd50b1f9edeca5))
* introduce DensityControl component and update layout preferences for improved grid management ([74feba0](https://github.com/tonygorb/scenri/commit/74feba035926f15d16fa09f83cab9b2a550b55c8))
* introduce presenters feature with API integration and UI components ([cb3b352](https://github.com/tonygorb/scenri/commit/cb3b35297df53ae40a0984d0803ed176e69d1b6c))
* introduce scenes feature with API integration and UI components ([78ac864](https://github.com/tonygorb/scenri/commit/78ac864027d298412dfaa8a35f5b3306980afef5))
* persist composer drafts and unify look-switch handling ([ede3a1e](https://github.com/tonygorb/scenri/commit/ede3a1e2ff6a8edb62eacc49ecab87c5724f7035))
* refactor BriefInput and introduce new tab transition and verticals tabs components ([de8fbe2](https://github.com/tonygorb/scenri/commit/de8fbe2a635e791b3619b5276e650e21275b8f82))
* refine template descriptions and prompts for enhanced product realism ([c681806](https://github.com/tonygorb/scenri/commit/c68180607bf92a2091067344588caa6a85e62846))
* remove outdated showcase images and templates for improved content management ([0d57e99](https://github.com/tonygorb/scenri/commit/0d57e99d12d84cc956367ddae68aca502f658f8e))
* scenri 0.1.0 ([81bc992](https://github.com/tonygorb/scenri/commit/81bc9923750c84c82e69d8072fe184b2107cd62c))
* the scenri mark in the top bar, with favicons and app icons ([ed595c7](https://github.com/tonygorb/scenri/commit/ed595c755303a8f82b4cc3f14a3daded645ab171))
* update category and template details for improved product representation ([85e6c54](https://github.com/tonygorb/scenri/commit/85e6c545c6e8be7e437650359789b2b3e604e468))
* update look templates and prompts for enhanced product presentation ([3b2e3ae](https://github.com/tonygorb/scenri/commit/3b2e3aeb20909900f69bcf591fcabc8fbfa07507))
* update product categories and enhance demo product references ([2d48533](https://github.com/tonygorb/scenri/commit/2d4853359a86e44954d9d75de910859a0028c243))
* update scene count and enhance template details for improved realism ([7292439](https://github.com/tonygorb/scenri/commit/72924390ef17ac6f37498ac963f1304ca3b9166b))
* update scene count and enhance template prompts for improved product realism ([f6fd251](https://github.com/tonygorb/scenri/commit/f6fd251c38426be733c4fff73a756f04a4407f9b))
* update ShowcaseCard component and styles for improved visual consistency ([cdd0055](https://github.com/tonygorb/scenri/commit/cdd0055d26816503e971dee47cf5225be6996dc2))
* update template details and prompts for enhanced product realism ([41111f5](https://github.com/tonygorb/scenri/commit/41111f5b227f0c6993db0be8adfe8e00bccf3bf3))
* update template dimensions and descriptions for improved product presentation ([583ace8](https://github.com/tonygorb/scenri/commit/583ace8b1b63dd6bebc2a1ece257ca44526bb222))
* **updates:** one-click apply and graceful restart ([a87d8d6](https://github.com/tonygorb/scenri/commit/a87d8d6f3b4ae080b1de33de5a358c97de78b2b9))
* **updates:** version awareness and update notification ([59dddf7](https://github.com/tonygorb/scenri/commit/59dddf7b8ed01df82bcd73922849493d28392b49))
* **updates:** what's new, and the release record that feeds it ([9a5c259](https://github.com/tonygorb/scenri/commit/9a5c25939213fb718c3c68b66cb92defe96f1cae))


### Bug Fixes

* **a11y:** name the showcase credit chip without an invalid aria-label ([d8a10c0](https://github.com/tonygorb/scenri/commit/d8a10c0b82e128b5c18730532f1d21af07b64ffd))
* **assets:** keep the remove button off the swatch it sits on ([9cd49ab](https://github.com/tonygorb/scenri/commit/9cd49abb1f5cb177c5c380502899dfc895545316))
* **ci:** install WebKit, cap e2e, verify before publishing, ignore .npmrc ([933b75b](https://github.com/tonygorb/scenri/commit/933b75b61b11b49a7a600dc9035d3b52f75a54aa))
* **ci:** keep CLA signatures on a dedicated branch ([b7904ac](https://github.com/tonygorb/scenri/commit/b7904ac5d10fb60eaeb04c96768604874eb06859))
* **composer:** bind the insert menu keys before it paints ([706cfda](https://github.com/tonygorb/scenri/commit/706cfda87313388ce7872d429a29e7ca42603a2a))
* **composer:** stop Enter firing the shot it just placed a chip in ([027a067](https://github.com/tonygorb/scenri/commit/027a067561f85165eb6b51128ce31413ae09bee9))
* **e2e:** update routing tests for scene and product navigation ([8c9ba99](https://github.com/tonygorb/scenri/commit/8c9ba99f2dadbc7449133b6434260b1f45dca7e5))
* green the e2e suite and drop the stray package symlinks ([8213753](https://github.com/tonygorb/scenri/commit/82137539a32698d22a6a72c166931edc78d2abba))
* improve handling of missing data in routes ([c8ae1fa](https://github.com/tonygorb/scenri/commit/c8ae1fa77a2d4b5f78b4e748624c9f998904d25c))
* never link release tags the 0.1.x builds never had ([21ff151](https://github.com/tonygorb/scenri/commit/21ff151c8852adc7cfd9a08f0f99cc8ccb29bd5d))
* reject cross-site requests and lock down the library folder ([3f71386](https://github.com/tonygorb/scenri/commit/3f713869a8b21f94a6a00be30936e205979eaedb))
* **release:** stop release-please skipping its own releases ([6a22bec](https://github.com/tonygorb/scenri/commit/6a22becaeac24e76553f93b84dc2d65d610b1224))
* ship the Apache license in the tarball and verify the pack first ([8e09b35](https://github.com/tonygorb/scenri/commit/8e09b35560d3ce135b57e8d8aed2feb4754bc124))
* **updates:** a development build says so, rather than blaming a release ([e72aa7a](https://github.com/tonygorb/scenri/commit/e72aa7a59edc476c7c2f622ccff4fced4146a447))
* **updates:** say 'nothing published yet', not 'couldn't fetch' ([66cfabb](https://github.com/tonygorb/scenri/commit/66cfabb097a3facbabcefbc80325ea5210cedfb3))

## Changelog

The public history of scenri begins at 0.2.0. Earlier internal versions
(0.1.x) predate this repository.
