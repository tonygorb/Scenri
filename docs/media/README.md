...
|---|---|---|
| `demo.gif` | the lead, under the tagline | 960x540, 15fps, 24 seconds, 2.0 MB. The whole film, rendered at 820 |
...
| `library.gif` | under "What you get out of the box" | 960x540, 12fps, 7.2 seconds, 6.3 MB. One slow scroll down the home wall, cut at 0.8x from the same master as `library.mp4` |
| `library.mp4` | not embedded | the same scroll, 1920x1080 H.264 at 60fps, 9 seconds, 11.5 MB. Drag it into a GitHub release or issue for a real inline player |
