...
- **The refine field carries no band.** The chips that sat over it were the source picture's contents with no word saying so. The record above the field states them once, under one quiet line, `Carried over`: the ask is what changed, the carried group is what stayed, the world scene among them. One chip voice for both; the line is the distinction.
