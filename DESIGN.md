...
- **A refinement's record is its ask.** The chips that sat over the refine field, and the "carried" group the record used to add under the ask, were the references the request sent along, said as if they were the picture's contents; after "remove the person" the person was still listed. Neither exists. The record under BRIEF is the sentence and the chips this shot asked for, nothing more; what the thread is made of is said once, on the Original, one step down the trail.
